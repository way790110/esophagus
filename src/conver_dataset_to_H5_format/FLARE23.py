...
def main():
    # image_root = pathlib.Path(r'dataset\FLARE_2023\FLARE23_1-1000')
    # label_root = pathlib.Path(r'dataset\FLARE_2023\MICCAI-FLARE23-20240429T033357Z-002\MICCAI-FLARE23\labelsTr2200\labelsTr2200\labelsTr1000')
    image_root = pathlib.Path(r'dataset\FLARE_2023\FLARE23_2001-2200-006')
    label_root = pathlib.Path(r'dataset\FLARE_2023\MICCAI-FLARE23-20240429T033357Z-002\MICCAI-FLARE23\labelsTr2200\labelsTr2200\labelsTr2200')
    ...
    for image_path in image_root.glob("*"):
        ...
        save_path = pathlib.Path(*[r'dataset\h5\FLARE23', file_name[:-5] + '.h5'])
        ...
        assert image.shape[0] == mask.shape[0], 'ERROR: wrong lenght'
        ...
        for i in range(len(image)):
            ...
            save_path = pathlib.Path(*[r'dataset\png\FLARE23', file_name[:-5], f'{i}.png'])
            save_path.parent.mkdir(exist_ok=True, parents=True)
